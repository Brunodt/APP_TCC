package com.example.logincadastro.bluetoothHelper;
...
import com.example.logincadastro.InterfaceConexao;
...
public class ConnectionThread extends  Thread {
        ...
        if(btSocket != null) {
            ...
            try {
                ...
                while(running) {
                    ...
                    toInterfaceConexao(Arrays.copyOfRange(buffer, 0, bytes));
     ...
     */
    private void toInterfaceConexao(byte[] data) {

        Message message = new Message();
        Bundle bundle = new Bundle();
        bundle.putByteArray("data", data);
        message.setData(bundle);
        InterfaceConexao.handler.sendMessage(message);
    }
